              ...
              <tr key={user._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                >
                  <img
                    ...
                    src={user.profilePicture || `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEJ6aCBAcZ4ldYdG3do9HOShAndpdghkiL74xysu9a-JezzYY-LK3nkp62Z8RPcHsZQAY&usqp=CAU` }
                    alt="Jese image"
                  />
                  <div className="pl-3">
                ...
                <td className="px-6 py-4 text-base font-semibold">{ user.email}</td>
